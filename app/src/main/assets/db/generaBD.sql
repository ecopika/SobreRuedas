...
CREATE TABLE IF NOT EXISTS mapa (ID INT PRIMARY KEY NOT NULL, INICIX FLOAT, INICIY FLOAT, NOMIMG TEXT, NOMIMG2 TEXT);
...
INSERT INTO mapa (ID, INICIX, INICIY,NOMIMG,NOMIMG2)VALUES (0,0.0,0.0,"mapbuit1","rampa");
