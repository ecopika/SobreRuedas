...
CREATE TABLE IF NOT EXISTS mapa (ID INT PRIMARY KEY NOT NULL,  NOMIMG TEXT, NOMIMG2 TEXT, TEXTTRANS TEXT);
...
CREATE TABLE IF NOT EXISTS perfil(ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NOMPERSONATGE TEXT, DIFICULTAT TEXT, PUNTUACIO TEXT);
...
INSERT INTO mapa (ID,NOMIMG,NOMIMG2,TEXTTRANS)VALUES (0,"mapbuit1","rampa","La Núria passeja per els voltants de Barcelona...");
INSERT INTO mapa (ID, NOMIMG,NOMIMG2,TEXTTRANS)VALUES (1,"mapa2buit","ascensor","La Núria torna cap a casa amb el metro...");
INSERT INTO mapa (ID, NOMIMG,NOMIMG2,TEXTTRANS)VALUES (2,"mapa3","mapa3sol","Quan la Núria entra a la botiga es troba que...");
